                ...
                <div class="wrapper">
                    <div class="header">
                        ...
                        <div class="search_box">
                            <input type="text" id="myInput" onkeyup="functionsearchID()" placeholder="Search for Order id.." title="Type in a name">
                            <input type="text" id="myInput2" onkeyup="functionsearchSTATUS()" placeholder="Search for Status.." title="Type in a name">
                            <input type="text" id="myInput3" onkeyup="functionsearchCANCELLED()" placeholder="Search for customer.." title="Type in a name">
                    ...
                    <div class="user-box" id="order-update"></div>
