...
<head>
    ...
    <script src="${pageContext.request.contextPath}/js/search-employee-page.js"></script>
...
<c:choose>
    <c:when test="${!empty sessionScope.email}">
        ...
        <div class="main-wrapper">
                ...
                <div class="scroll-sidebar">
                    ...
                    <nav class="sidebar-nav">
                        ...
                        <ul id="sidebarnav">
                            ...
                            <li>
                                <a class="nav-link" href="${pageContext.request.contextPath}/jsp/manager-page.jsp" aria-expanded="false" >
                                    <i class="fa fa-home" aria-hidden="true"></i><span class="hide-menu"> MANAGE AREA </span>
                                </a>
                            </li>
                            ...
                            <li class= active>
                                <a class="has-arrow sidebar-nav" href="#" aria-expanded="false">
                                    <i class="fa fa-user-circle" aria-hidden="true"></i><span class="hide-menu"> Manage Employee </span>
                                </a>
                                <ul aria-expanded="false" class="collapse">
                                    <li class= active>
                                        <a href="${pageContext.request.contextPath}/jsp/create-employee.jsp">
                                            <i class="mdi mdi-numeric-1-box"></i>
                                            Create Employee
                                        </a>
                                    </li>
                                    <li>
                                        <a href="${pageContext.request.contextPath}/jsp/manage-employee.jsp">
                            ...
                            <li>
                                ...
                                <ul aria-expanded="false" class="collapse">
                                    <li>
                                        <a href="${pageContext.request.contextPath}/jsp/manage-order-all-list.jsp">
                                            <i class="mdi mdi-numeric-1-box"></i>
                                            List All Order
                                        </a>
                                    </li>
                                    <li>
                                        <a href="${pageContext.request.contextPath}/jsp/manage-customer.jsp">
                                            <i class="mdi mdi-numeric-2-box"></i>
                                            Search Customer
                                        </a>
                                    </li>
                            ...
                            <li>
                                ...
                                <ul aria-expanded="false" class="collapse">
                                    <li>
                                        <a href="${pageContext.request.contextPath}/jsp/manage-appointment.jsp">
                                            <i class="mdi mdi-numeric-1-box"></i>
                                            Search appointment
                                        </a>
                                    </li>
            ...
            <!-- Page Content -->
            <div class="page-wrapper emp_creation">
                ...
                <div class="wrapper">
                    <div class="header">
                        ...
                        <div class="center">
                            <div>
                           <select class="form-control" name="user" id="user_selector"></select> <button type="button" id="select_user">Search</button><br>
                            </div>
                        </div>

                    </div>
                    <h3>User Details</h3>
                    <div id="user-info">Select an employee to see details</div>
                    <h3>Update Employee Details</h3>
                    <div id="user-update">Select an employee to update details</div>
