...
<head>
    ...
    <script src="${pageContext.request.contextPath}/js/search-customer-page.js"></script>
            ...
            <div class="page-wrapper">
                <div class="wrapper">
                    <div class="header">
                        ...
                        <div class="center">
                        <div>
                            <select class="form-control" name="customer" id="customer_selector"></select> <button type="button" id="select_customer">Search</button><br/>
                        </div>
                        </div>

                    </div>
                    <h3>Customer Details</h3>
                    <div id="customer-info">Select a user to see details</div>
                </div>
